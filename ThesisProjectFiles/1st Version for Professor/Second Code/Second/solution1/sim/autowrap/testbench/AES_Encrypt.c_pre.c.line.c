#pragma line 1 "C:/Users/Lincoln/Desktop/Professor/Second/CCodedFiles/2nd/AES_Encrypt.c"
...
#pragma empty_line
#pragma empty_line
void SubBytes(unsigned char state[4][4],int round,unsigned char RoundKey[240])
{
 int i,a,j;
 for(a=0;a<4;a++)
 {
