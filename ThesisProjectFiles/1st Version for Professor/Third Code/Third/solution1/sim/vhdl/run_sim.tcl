...
if {[file isfile aes_main.autotvin.dat]} {
	file delete -force aes_main.autotvin.dat
}

if {[file isfile aes_main.autotvout.dat]} {
	file delete -force aes_main.autotvout.dat
}
