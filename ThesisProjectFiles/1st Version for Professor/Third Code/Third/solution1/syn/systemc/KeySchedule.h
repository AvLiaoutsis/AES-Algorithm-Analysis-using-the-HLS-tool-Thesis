...
struct KeySchedule : public sc_module {
    ...
    sc_signal< sc_lv<9> > word_addr_reg_996;
    ...
    sc_signal< sc_lv<9> > word_addr_5_reg_1032;
    sc_signal< sc_lv<9> > word_addr_6_reg_1037;
    sc_signal< sc_lv<9> > word_addr_7_reg_1043;
    ...
    sc_signal< sc_lv<9> > word_addr_9_reg_1113;
