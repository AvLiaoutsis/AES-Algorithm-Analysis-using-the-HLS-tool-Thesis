...
struct aes_main : public sc_module {
    ...
    sc_signal< sc_lv<9> > grp_MixColumn_AddRoundKe_fu_96_word_address0;
    sc_signal< sc_logic > grp_MixColumn_AddRoundKe_fu_96_word_ce0;
    sc_signal< sc_lv<9> > grp_MixColumn_AddRoundKe_fu_96_word_address1;
    sc_signal< sc_logic > grp_MixColumn_AddRoundKe_fu_96_word_ce1;
    ...
    sc_signal< sc_lv<9> > grp_KeySchedule_fu_106_word_address0;
    sc_signal< sc_logic > grp_KeySchedule_fu_106_word_ce0;
    sc_signal< sc_logic > grp_KeySchedule_fu_106_word_we0;
    sc_signal< sc_lv<32> > grp_KeySchedule_fu_106_word_d0;
    sc_signal< sc_lv<9> > grp_KeySchedule_fu_106_word_address1;
    sc_signal< sc_logic > grp_KeySchedule_fu_106_word_ce1;
    ...
    sc_signal< sc_lv<9> > grp_AddRoundKey_fu_126_word_address0;
    sc_signal< sc_logic > grp_AddRoundKey_fu_126_word_ce0;
    sc_signal< sc_lv<9> > grp_AddRoundKey_fu_126_word_address1;
    sc_signal< sc_logic > grp_AddRoundKey_fu_126_word_ce1;
