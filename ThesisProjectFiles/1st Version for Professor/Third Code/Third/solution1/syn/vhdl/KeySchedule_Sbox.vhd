...
entity KeySchedule_Sbox_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of KeySchedule_Sbox_rom is 
...
architecture arch of KeySchedule_Sbox is
    component KeySchedule_Sbox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    KeySchedule_Sbox_rom_U :  component KeySchedule_Sbox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
