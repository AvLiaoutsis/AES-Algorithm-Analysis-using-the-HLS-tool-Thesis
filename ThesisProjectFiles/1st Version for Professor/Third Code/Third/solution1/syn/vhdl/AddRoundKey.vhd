...
begin
    ...
    grp_fu_133_p2 <= (statemt_q0 xor word_q0);
    grp_fu_139_p2 <= (statemt_q1 xor word_q1);
    ...
    word_address0_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state2, tmp_cast_fu_182_p1, tmp_100_cast_fu_239_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            word_address0 <= tmp_100_cast_fu_239_p1(9 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            word_address0 <= tmp_cast_fu_182_p1(9 - 1 downto 0);
        else 
    ...
    word_address1_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state2, tmp_99_cast_fu_197_p1, tmp_101_cast_fu_250_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            word_address1 <= tmp_101_cast_fu_250_p1(9 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            word_address1 <= tmp_99_cast_fu_197_p1(9 - 1 downto 0);
        else 
