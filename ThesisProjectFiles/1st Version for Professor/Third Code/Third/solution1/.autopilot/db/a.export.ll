...
@word = common global [480 x i32] zeroinitializer
...
._crit_edge_ifconv:                               ; preds = %1
  ...
  %word_addr = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_16_cast
  %tmp_34 = add i8 120, %tmp_16_cast_cast
  %tmp_38_cast = zext i8 %tmp_34 to i32
  %word_addr_1 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_38_cast
  %tmp_35 = add i9 240, %tmp_16_cast_cast1
  %tmp_39_cast = zext i9 %tmp_35 to i32
  %word_addr_2 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_39_cast
  %tmp_36 = add i9 -152, %tmp_16_cast_cast1
  %tmp_40_cast = zext i9 %tmp_36 to i32
  %word_addr_3 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_40_cast
  %word_load = load i32* %word_addr, align 4
  %tmp1 = xor i32 %x_2, %x_4
  %tmp3 = xor i32 %ret_load_1, %storemerge_v
  %tmp2 = xor i32 %tmp3, %word_load
  ...
  %word_load_1 = load i32* %word_addr_1, align 4
  %tmp4 = xor i32 %x_4, %x_6
  %tmp6 = xor i32 %storemerge8_v, %tmp_23_tmp_s
  %tmp5 = xor i32 %tmp6, %word_load_1
  ...
  %word_load_2 = load i32* %word_addr_2, align 4
  %tmp7 = xor i32 %x, %x_6
  %tmp9 = xor i32 %storemerge9_v, %tmp_33_tmp_s
  %tmp8 = xor i32 %tmp9, %word_load_2
  ...
  %word_load_3 = load i32* %word_addr_3, align 4
  %tmp10 = xor i32 %x_2, %x
  %tmp12 = xor i32 %storemerge1_v, %tmp_43_tmp_s
  %tmp11 = xor i32 %tmp12, %word_load_3
...
.preheader4:                                      ; preds = %1, %.preheader4.preheader
  ...
  %word_addr = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_53
...
; <label>:1                                       ; preds = %.preheader4
  ...
  store i32 %key_load, i32* %word_addr, align 4
  br label %.preheader4
...
; <label>:2                                       ; preds = %.preheader
  ...
  %word_addr_4 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_58_cast
  %tmp_56 = add i9 240, %tmp_50_cast_cast1
  %tmp_59_cast = zext i9 %tmp_56 to i32
  %word_addr_5 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_59_cast
  %tmp_57 = add i9 -152, %tmp_50_cast_cast1
  %tmp_60_cast = zext i9 %tmp_57 to i32
  %word_addr_6 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_60_cast
  %word_addr_7 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_50_cast
  br i1 %tmp_s, label %._crit_edge, label %.critedge

._crit_edge:                                      ; preds = %2
  %word_load_5 = load i32* %word_addr_4, align 4
  %tmp_58 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %word_load_5, i32 31)
  %tmp_59 = trunc i32 %word_load_5 to i4
  %p_neg1 = sub i32 0, %word_load_5
  ...
  %tmp_65 = call i6 @_ssdm_op_PartSelect.i6.i32.i32.i32(i32 %word_load_5, i32 4, i32 9)
  ...
  %word_load_6 = load i32* %word_addr_5, align 4
  %tmp_68 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %word_load_6, i32 31)
  %tmp_69 = trunc i32 %word_load_6 to i4
  %p_neg2 = sub i32 0, %word_load_6
  ...
  %tmp_75 = call i6 @_ssdm_op_PartSelect.i6.i32.i32.i32(i32 %word_load_6, i32 4, i32 9)
  ...
  %word_load_7 = load i32* %word_addr_6, align 4
  %tmp_78 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %word_load_7, i32 31)
  %tmp_79 = trunc i32 %word_load_7 to i4
  %p_neg9 = sub i32 0, %word_load_7
  ...
  %tmp_86 = call i6 @_ssdm_op_PartSelect.i6.i32.i32.i32(i32 %word_load_7, i32 4, i32 9)
  ...
  %word_load_8 = load i32* %word_addr_7, align 4
  %tmp_88 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %word_load_8, i32 31)
  %tmp_89 = trunc i32 %word_load_8 to i4
  %p_neg = sub i32 0, %word_load_8
  ...
  %tmp_101 = call i6 @_ssdm_op_PartSelect.i6.i32.i32.i32(i32 %word_load_8, i32 4, i32 9)
...
.critedge:                                        ; preds = %2
  %temp_0_1 = load i32* %word_addr_7, align 4
  %temp_1_1 = load i32* %word_addr_4, align 4
  %temp_2_1 = load i32* %word_addr_5, align 4
  %word_load = load i32* %word_addr_6, align 4
  br label %._crit_edge5
...
._crit_edge5:                                     ; preds = %.critedge, %._crit_edge
  ...
  %temp_3 = phi i32 [ %Sbox_load_3_cast, %._crit_edge ], [ %word_load, %.critedge ]
  %tmp_35 = add i6 %j_1, -4
...
; <label>:3                                       ; preds = %4, %._crit_edge5
  ...
  %word_addr_8 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_96_cast
  %tmp_97 = add i10 %tmp_95, %j_1_cast2_cast
  %tmp_97_cast = sext i10 %tmp_97 to i32
  %word_addr_9 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_97_cast
...
; <label>:4                                       ; preds = %3
  %word_load_4 = load i32* %word_addr_8, align 4
  ...
  %tmp_36 = xor i32 %word_load_4, %tmp_13
  store i32 %tmp_36, i32* %word_addr_9, align 4
  br label %3
...
; <label>:1                                       ; preds = %0
  ...
  %word_addr = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_cast
  %tmp_98 = add i8 120, %tmp_cast_cast
  %tmp_99_cast = zext i8 %tmp_98 to i32
  %word_addr_10 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_99_cast
  %tmp_99 = add i9 240, %tmp_cast_cast1
  %tmp_100_cast = zext i9 %tmp_99 to i32
  %word_addr_11 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_100_cast
  %tmp_100 = add i9 -152, %tmp_cast_cast1
  %tmp_101_cast = zext i9 %tmp_100 to i32
  %word_addr_12 = getelementptr [480 x i32]* @word, i32 0, i32 %tmp_101_cast
  %word_load = load i32* %word_addr, align 4
  ...
  %statemt_load = load i32* %statemt_addr, align 4
  %tmp_38 = xor i32 %statemt_load, %word_load
  store i32 %tmp_38, i32* %statemt_addr, align 4
  %word_load_5 = load i32* %word_addr_10, align 4
  ...
  %tmp_40 = xor i32 %statemt_load_19, %word_load_5
  store i32 %tmp_40, i32* %statemt_addr_23, align 4
  %word_load_6 = load i32* %word_addr_11, align 4
  ...
  %tmp_42 = xor i32 %statemt_load_20, %word_load_6
  store i32 %tmp_42, i32* %statemt_addr_24, align 4
  %word_load_7 = load i32* %word_addr_12, align 4
  ...
  %tmp_44 = xor i32 %statemt_load_21, %word_load_7
