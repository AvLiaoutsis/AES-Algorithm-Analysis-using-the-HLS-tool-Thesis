...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("statemt_address1", 5, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("statemt_ce1", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("statemt_we1", 1, hls_out, 0, "ap_memory", "mem_we", 1),
	Port_Property("statemt_d1", 32, hls_out, 0, "ap_memory", "mem_din", 1),
	Port_Property("statemt_q1", 32, hls_in, 0, "ap_memory", "mem_dout", 1),
