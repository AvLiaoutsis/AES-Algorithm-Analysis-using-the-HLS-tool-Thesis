set C_TypeInfoList {{ 
"aes_main" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"statemt": [[], {"array": [ {"scalar": "int"}, [32]]}] }, {"key": [[], {"array": [ {"scalar": "int"}, [32]]}] }, {"out": [[], {"array": [ {"scalar": "int"}, [32]]}] }],["0"],""],
 "0": [ "word", [[], {"array": [ {"scalar": "int"}, [4,120]]}],""]
}}
...
set C_modelArgMapList {[ 
	{ "Name" : "statemt", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "statemt","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "key", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "key","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "out_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "out","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 31,"step" : 1}]}]}]} ]}
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "8", "10"],
		...
		"Port" : [
			...
			{"Name" : "word", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_AddRoundKey_fu_126", "Port" : "word"},
					{"ID" : "4", "SubInstance" : "grp_KeySchedule_fu_106", "Port" : "word"},
					{"ID" : "2", "SubInstance" : "grp_MixColumn_AddRoundKe_fu_96", "Port" : "word"}]},
