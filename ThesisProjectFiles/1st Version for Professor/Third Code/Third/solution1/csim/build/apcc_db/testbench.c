...
if (AESL_DEBUG_TRACE)
printf("\n  call void bitcast (void (...)* @aes_main to void (i32*, i32*, i32*)*)(i32* %%1, i32* %%17, i32* %%33) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_69_count);
  aes_main((signed int *)llvm_cbe_tmp__1, (signed int *)llvm_cbe_tmp__17, (signed int *)llvm_cbe_tmp__33);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
