...
void AESL_WRAP_Cipher(signed int , signed int ,  char *);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_Cipher(i32 10, i32 4, i8* %%1) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_11_count);
  AESL_WRAP_Cipher(10u, 4u, ( char *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",10u);
printf("\nArgument  = 0x%X",4u);
}
