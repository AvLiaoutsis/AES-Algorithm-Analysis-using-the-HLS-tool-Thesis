...
#define AUTOTB_TVIN_Nr  "../tv/cdatafile/c.Cipher.autotvin_Nr.dat"
// wrapc file define: "Nk"
#define AUTOTB_TVIN_Nk  "../tv/cdatafile/c.Cipher.autotvin_Nk.dat"
// wrapc file define: "out_r"
#define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.Cipher.autotvout_out_r.dat"
#define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.Cipher.autotvin_out_r.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "out_r"
#define AUTOTB_TVOUT_PC_out_r  "../tv/rtldatafile/rtl.Cipher.autotvout_out_r.dat"
...
char out[16])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *out_r_pc_buffer = new sc_bv<8>[16];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_r
				{
					...
					// {
						// celement: out(7, 0)
						// {
							sc_lv<8>* out_lv0_0_15_1 = new sc_lv<8>[16];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						// celement: out(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 15; i_0 += 1)
							{
								...
								{
									out_lv0_0_15_1[hls_map_index].range(7, 0) = sc_bv<8>(out_r_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: out(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 15; i_0 += 1)
							{
								...
								// output_type_conversion : (out_lv0_0_15_1[hls_map_index]).to_uint64()
								if (&(out[0]) != NULL) // check the null address if the c port is array or others
								{
									out[i_0] = (out_lv0_0_15_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		// [[transaction]]
		sprintf(tvin_Nk, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_Nk, tvin_Nk);

		sc_bv<32> Nk_tvin_wrapc_buffer;
			...
			// bitslice(31, 0)
			{
				// celement: Nk(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						// ori_name              : Nk
						// sub_1st_elem          : 
						// ori_name_1st_elem     : Nk
						// regulate_c_name       : Nk
						// input_type_conversion : Nk
						if (&(Nk) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> Nk_tmp_mem;
							Nk_tmp_mem = Nk;
							Nk_tvin_wrapc_buffer.range(31, 0) = Nk_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_Nk, "%s\n", (Nk_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_Nk, tvin_Nk);
		}

		tcl_file.set_num(1, &tcl_file.Nk_depth);
		sprintf(tvin_Nk, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_Nk, tvin_Nk);
		...
		sc_bv<8>* out_r_tvin_wrapc_buffer = new sc_bv<8>[16];
		...
		tcl_file.set_num(16, &tcl_file.out_r_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<8>* out_r_tvout_wrapc_buffer = new sc_bv<8>[16];
