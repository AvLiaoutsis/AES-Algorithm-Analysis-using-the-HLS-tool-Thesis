...
AddRoundKey::AddRoundKey(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_25_cast_fu_131_p1 );
    ...
    sensitive << ( tmp_cast_reg_196 );
    sensitive << ( tmp1_fu_151_p4 );

    SC_METHOD(thread_tmp1_fu_151_p4);
    sensitive << ( j_reg_71 );
    sensitive << ( tmp_38_fu_148_p1 );

    SC_METHOD(thread_tmp_16_fu_114_p3);
    sensitive << ( j_reg_71 );

    SC_METHOD(thread_tmp_17_fu_126_p2);
    sensitive << ( i_cast4_cast_reg_183 );
    sensitive << ( tmp_24_cast_fu_122_p1 );

    SC_METHOD(thread_tmp_24_cast_fu_122_p1);
    sensitive << ( tmp_16_fu_114_p3 );

    SC_METHOD(thread_tmp_25_cast_fu_131_p1);
    sensitive << ( tmp_17_fu_126_p2 );

    SC_METHOD(thread_tmp_38_fu_148_p1);
    sensitive << ( round );
    ...
    sc_trace(mVcdFile, i_cast4_cast_reg_183, "i_cast4_cast_reg_183");
    ...
    sc_trace(mVcdFile, tmp_cast_reg_196, "tmp_cast_reg_196");
    ...
    sc_trace(mVcdFile, j_3_reg_209, "j_3_reg_209");
    ...
    sc_trace(mVcdFile, tmp_25_cast_fu_131_p1, "tmp_25_cast_fu_131_p1");
    ...
    sc_trace(mVcdFile, tmp_16_fu_114_p3, "tmp_16_fu_114_p3");
    sc_trace(mVcdFile, tmp_24_cast_fu_122_p1, "tmp_24_cast_fu_122_p1");
    sc_trace(mVcdFile, tmp_17_fu_126_p2, "tmp_17_fu_126_p2");
    sc_trace(mVcdFile, tmp_38_fu_148_p1, "tmp_38_fu_148_p1");
...
void AddRoundKey::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
        ...
        j_reg_71 = j_3_reg_209.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_3_reg_191 = i_3_fu_92_p2.read();
        i_cast4_cast_reg_183 = i_cast4_cast_fu_82_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        j_3_reg_209 = j_3_fu_142_p2.read();
        state_addr_reg_201 =  (sc_lv<4>) (tmp_25_cast_fu_131_p1.read());
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(exitcond1_fu_86_p2.read(), ap_const_lv1_0))) {
        tmp_cast_reg_196 = tmp_cast_fu_110_p1.read();
    }
}
...
void AddRoundKey::thread_state_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        ...
        state_address0 =  (sc_lv<4>) (tmp_25_cast_fu_131_p1.read());
    } else {
        state_address0 = "XXXX";
    }
}
...
void AddRoundKey::thread_sum3_fu_161_p2() {
    sum3_fu_161_p2 = (!tmp1_fu_151_p4.read().is_01() || !tmp_cast_reg_196.read().is_01())? sc_lv<8>(): (sc_biguint<8>(tmp1_fu_151_p4.read()) + sc_biguint<8>(tmp_cast_reg_196.read()));
}

void AddRoundKey::thread_tmp1_fu_151_p4() {
    tmp1_fu_151_p4 = esl_concat<5,3>(esl_concat<4,1>(tmp_38_fu_148_p1.read(), ap_const_lv1_0), j_reg_71.read());
}

void AddRoundKey::thread_tmp_16_fu_114_p3() {
    tmp_16_fu_114_p3 = esl_concat<3,2>(j_reg_71.read(), ap_const_lv2_0);
}

void AddRoundKey::thread_tmp_17_fu_126_p2() {
    tmp_17_fu_126_p2 = (!i_cast4_cast_reg_183.read().is_01() || !tmp_24_cast_fu_122_p1.read().is_01())? sc_lv<6>(): (sc_biguint<6>(i_cast4_cast_reg_183.read()) + sc_biguint<6>(tmp_24_cast_fu_122_p1.read()));
}

void AddRoundKey::thread_tmp_24_cast_fu_122_p1() {
    tmp_24_cast_fu_122_p1 = esl_zext<6,5>(tmp_16_fu_114_p3.read());
}

void AddRoundKey::thread_tmp_25_cast_fu_131_p1() {
    tmp_25_cast_fu_131_p1 = esl_zext<32,6>(tmp_17_fu_126_p2.read());
}

void AddRoundKey::thread_tmp_38_fu_148_p1() {
    tmp_38_fu_148_p1 = round.read().range(4-1, 0);
}
