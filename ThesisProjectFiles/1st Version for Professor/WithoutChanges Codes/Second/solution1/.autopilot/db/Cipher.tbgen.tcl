set C_TypeInfoList {{ 
"Cipher" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"Key": [[], {"array": ["0", [32]]}] }, {"state": [[], {"array": [ {"array": ["0", [4]]}, [4]]}] }],[],""], 
...
set portList { 
	...
	{ state_d1 sc_out sc_lv 32 signal 1 } 
	{ state_q1 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "5", "6"],
		...
		"VariableLatency" : "1",
		"WaitState" : [
			{"State" : "ap_ST_fsm_state2", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_KeyExpansion_fu_244"},
			{"State" : "ap_ST_fsm_state4", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_AddRoundKey_fu_256"},
			{"State" : "ap_ST_fsm_state23", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_AddRoundKey_fu_256"},
			{"State" : "ap_ST_fsm_state38", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_AddRoundKey_fu_256"},
			{"State" : "ap_ST_fsm_state6", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_SubBytes_fu_266"},
			{"State" : "ap_ST_fsm_state24", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_SubBytes_fu_266"}],
		"Port" : [
			{"Name" : "Key", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_KeyExpansion_fu_244", "Port" : "Key"}]},
			{"Name" : "state", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_AddRoundKey_fu_256", "Port" : "state"},
					{"ID" : "6", "SubInstance" : "grp_SubBytes_fu_266", "Port" : "state"}]},
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_SubBytes_fu_266", "Port" : "sbox"},
					{"ID" : "2", "SubInstance" : "grp_KeyExpansion_fu_244", "Port" : "sbox"}]},
			{"Name" : "Rcon", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_KeyExpansion_fu_244", "Port" : "Rcon"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.RoundKey_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_KeyExpansion_fu_244", "Parent" : "0", "Child" : ["3", "4"],
		"CDFG" : "KeyExpansion",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			...
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "Rcon", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_KeyExpansion_fu_244.sbox_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_KeyExpansion_fu_244.Rcon_U", "Parent" : "2"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_AddRoundKey_fu_256", "Parent" : "0",
		"CDFG" : "AddRoundKey",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_SubBytes_fu_266", "Parent" : "0", "Child" : ["7"],
		"CDFG" : "SubBytes",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			{"Name" : "state", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_SubBytes_fu_266.sbox_U", "Parent" : "6"}]}


set ArgLastReadFirstWriteLatency {
	Cipher {
		Key {Type I LastRead 3 FirstWrite -1}
		state {Type IO LastRead 20 FirstWrite 3}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "1863", "Max" : "1863"}
]}
