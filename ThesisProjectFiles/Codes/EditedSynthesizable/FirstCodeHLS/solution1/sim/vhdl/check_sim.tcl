...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.encrypt_128_key_expand_inline_no_branch.autotvin_state.dat"
         "c.encrypt_128_key_expand_inline_no_branch.autotvin_key.dat"
         "c.encrypt_128_key_expand_inline_no_branch.autotvout_state.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.encrypt_128_key_expand_inline_no_branch.autotvout_state.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
