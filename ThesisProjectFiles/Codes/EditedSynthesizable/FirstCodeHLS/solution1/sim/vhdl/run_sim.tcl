...
if {[file isfile encrypt_128_key_expand_inline_no_branch.autotvin.dat]} {
	file delete -force encrypt_128_key_expand_inline_no_branch.autotvin.dat
}

if {[file isfile encrypt_128_key_expand_inline_no_branch.autotvout.dat]} {
	file delete -force encrypt_128_key_expand_inline_no_branch.autotvout.dat
}
