...
void AESL_WRAP_encrypt_128_key_expand_inline_no_branch(signed int *, signed int *);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @aesl_internal_.str3, i32 0, i32 0)) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_14_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_encrypt_128_key_expand_inline_no_branch(i32* %%2, i32* %%3) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_16_count);
  AESL_WRAP_encrypt_128_key_expand_inline_no_branch((signed int *)llvm_cbe_tmp__2, (signed int *)llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = bitcast i32* %%w to i8*, !dbg !5 for 0x%I64xth hint within @print_verilog_hex  --> \n", ++aesl_llvm_cbe_51_count);
