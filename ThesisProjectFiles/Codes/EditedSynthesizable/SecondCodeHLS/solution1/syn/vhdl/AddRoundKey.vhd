...
architecture behav of AddRoundKey is 
    ...
    signal i_cast4_cast_reg_187 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal i_3_fu_92_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_3_reg_195 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_cast_fu_110_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_cast_reg_200 : STD_LOGIC_VECTOR (7 downto 0);
    signal exitcond1_fu_86_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal state_addr_reg_205 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal j_3_fu_142_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal j_3_reg_213 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_29_cast_fu_131_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_20_fu_114_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_28_cast_fu_122_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_21_fu_126_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_42_fu_148_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp1_fu_151_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum3_fu_161_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_18_fu_171_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                i_3_reg_195 <= i_3_fu_92_p2;
                    i_cast4_cast_reg_187(2 downto 0) <= i_cast4_cast_fu_82_p1(2 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                j_3_reg_213 <= j_3_fu_142_p2;
                state_addr_reg_205 <= tmp_29_cast_fu_131_p1(4 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond1_fu_86_p2 = ap_const_lv1_0))) then
                    tmp_cast_reg_200(3 downto 2) <= tmp_cast_fu_110_p1(3 downto 2);
            end if;
        end if;
    end process;
    i_cast4_cast_reg_187(5 downto 3) <= "000";
    tmp_cast_reg_200(1 downto 0) <= "00";
    tmp_cast_reg_200(7 downto 4) <= "0000";
    ...
    state_address0_assign_proc : process(state_addr_reg_205, ap_CS_fsm_state3, ap_CS_fsm_state4, tmp_29_cast_fu_131_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            state_address0 <= state_addr_reg_205;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            state_address0 <= tmp_29_cast_fu_131_p1(4 - 1 downto 0);
        else 
            state_address0 <= "XXXX";
        end if; 
    end process;
    ...
    state_d0 <= (state_q0 xor tmp_18_fu_171_p1);
    ...
    sum3_fu_161_p2 <= std_logic_vector(unsigned(tmp1_fu_151_p4) + unsigned(tmp_cast_reg_200));
    tmp1_fu_151_p4 <= ((tmp_42_fu_148_p1 & ap_const_lv1_0) & j_reg_71);
    tmp_18_fu_171_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(RoundKey_q0),32));
    tmp_20_fu_114_p3 <= (j_reg_71 & ap_const_lv2_0);
    tmp_21_fu_126_p2 <= std_logic_vector(unsigned(i_cast4_cast_reg_187) + unsigned(tmp_28_cast_fu_122_p1));
    tmp_28_cast_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_20_fu_114_p3),6));
    tmp_29_cast_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_21_fu_126_p2),32));
    tmp_42_fu_148_p1 <= round(4 - 1 downto 0);
