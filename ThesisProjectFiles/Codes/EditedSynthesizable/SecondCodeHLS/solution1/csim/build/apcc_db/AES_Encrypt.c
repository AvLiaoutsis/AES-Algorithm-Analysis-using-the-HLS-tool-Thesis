...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AddRoundKey(i32 %%storemerge28, [4 x i8]* %%65, i8* %%14), !dbg !10 for 0x%I64xth hint within @Cipher  --> \n", ++aesl_llvm_cbe_1470_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%67 = add nsw i32 %%storemerge28, 1, !dbg !10 for 0x%I64xth hint within @Cipher  --> \n", ++aesl_llvm_cbe_1471_count);
