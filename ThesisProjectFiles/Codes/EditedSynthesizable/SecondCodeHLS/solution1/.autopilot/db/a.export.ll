...
; <label>:2                                       ; preds = %1
  %tmp_2 = trunc i3 %i to i2
  %tmp = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %tmp_2, i2 0)
  %tmp_cast = zext i4 %tmp to i32
  %Key_addr = getelementptr [32 x i32]* %Key, i32 0, i32 %tmp_cast
  %Key_load = load i32* %Key_addr, align 4
  %tmp_4 = trunc i32 %Key_load to i8
  %RoundKey_addr = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %tmp_cast
  store i8 %tmp_4, i8* %RoundKey_addr, align 1
  %tmp_1 = or i4 %tmp, 1
  %tmp_1_cast = zext i4 %tmp_1 to i32
  %Key_addr_1 = getelementptr [32 x i32]* %Key, i32 0, i32 %tmp_1_cast
  %Key_load_1 = load i32* %Key_addr_1, align 4
  %tmp_6 = trunc i32 %Key_load_1 to i8
  %RoundKey_addr_1 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %tmp_1_cast
  store i8 %tmp_6, i8* %RoundKey_addr_1, align 1
  %tmp_3 = or i4 %tmp, 2
  %tmp_3_cast = zext i4 %tmp_3 to i32
  %Key_addr_2 = getelementptr [32 x i32]* %Key, i32 0, i32 %tmp_3_cast
  %Key_load_2 = load i32* %Key_addr_2, align 4
  %tmp_18 = trunc i32 %Key_load_2 to i8
  %RoundKey_addr_2 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %tmp_3_cast
  store i8 %tmp_18, i8* %RoundKey_addr_2, align 1
  %tmp_5 = or i4 %tmp, 3
  %tmp_5_cast = zext i4 %tmp_5 to i32
  %Key_addr_3 = getelementptr [32 x i32]* %Key, i32 0, i32 %tmp_5_cast
  %Key_load_3 = load i32* %Key_addr_3, align 4
  %tmp_19 = trunc i32 %Key_load_3 to i8
  %RoundKey_addr_3 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %tmp_5_cast
  store i8 %tmp_19, i8* %RoundKey_addr_3, align 1
  br label %1

.preheader3:                                      ; preds = %.preheader3.preheader, %_ifconv24
  %temp_3 = phi i8 [ %temp_3_1_34, %_ifconv24 ], [ undef, %.preheader3.preheader ]
  %temp_2 = phi i8 [ %temp_2_1_35, %_ifconv24 ], [ undef, %.preheader3.preheader ]
  %temp_1 = phi i8 [ %temp_1_1, %_ifconv24 ], [ undef, %.preheader3.preheader ]
  %temp = phi i8 [ %temp_0_2, %_ifconv24 ], [ undef, %.preheader3.preheader ]
  %i_1 = phi i6 [ %i_2, %_ifconv24 ], [ 4, %.preheader3.preheader ]
  %exitcond1 = icmp eq i6 %i_1, -20
  %empty_29 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 40, i64 40, i64 40)
...
.preheader:                                       ; preds = %_ifconv, %.preheader.preheader
  %temp_3_1 = phi i8 [ %temp_3, %.preheader.preheader ], [ %temp_3_3, %_ifconv ]
  %temp_2_1 = phi i8 [ %temp_2, %.preheader.preheader ], [ %temp_3_4, %_ifconv ]
  %temp_3_5 = phi i8 [ %temp_1, %.preheader.preheader ], [ %temp_3_7, %_ifconv ]
  %temp_3_8 = phi i8 [ %temp, %.preheader.preheader ], [ %temp_3_9, %_ifconv ]
...
_ifconv:                                          ; preds = %.preheader
  ...
  %sum8 = add i8 %tmp29_cast, %tmp_8
  %sum8_cast = zext i8 %sum8 to i32
  %RoundKey_addr_4 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %sum8_cast
  %temp_0 = load i8* %RoundKey_addr_4, align 1
  %tmp_21 = trunc i3 %j to i2
  %sel_tmp = icmp eq i2 %tmp_21, -2
  %sel_tmp2 = icmp eq i2 %tmp_21, 1
  %sel_tmp4 = icmp eq i2 %tmp_21, 0
  %or_cond = or i1 %sel_tmp4, %sel_tmp2
  %newSel = select i1 %sel_tmp, i8 %temp_3_1, i8 %temp_0
  %temp_3_3 = select i1 %or_cond, i8 %temp_3_1, i8 %newSel
  %newSel2 = select i1 %sel_tmp, i8 %temp_0, i8 %temp_2_1
  %temp_3_4 = select i1 %or_cond, i8 %temp_2_1, i8 %newSel2
  %temp_3_6 = select i1 %sel_tmp2, i8 %temp_0, i8 %temp_3_5
  %temp_3_7 = select i1 %sel_tmp4, i8 %temp_3_5, i8 %temp_3_6
  %temp_3_9 = select i1 %sel_tmp4, i8 %temp_0, i8 %temp_3_8
  br label %.preheader

_ifconv24:                                        ; preds = %.preheader
  %tmp_20 = trunc i6 %i_1 to i2
  %tmp_9 = icmp eq i2 %tmp_20, 0
  %num_assign = zext i8 %temp_3_5 to i32
  ...
  %temp_2_32 = load i8* %sbox_addr_2, align 1
  %num_assign_3 = zext i8 %temp_3_8 to i32
  %sbox_addr_3 = getelementptr [256 x i8]* @sbox, i32 0, i32 %num_assign_3
  %temp_3_33 = load i8* %sbox_addr_3, align 1
  %p_lshr_f_cast = call i4 @_ssdm_op_PartSelect.i4.i6.i32.i32(i6 %i_1, i32 2, i32 5)
  %tmp_s = zext i4 %p_lshr_f_cast to i32
  %Rcon_addr = getelementptr [255 x i8]* @Rcon, i32 0, i32 %tmp_s
  %Rcon_load = load i8* %Rcon_addr, align 1
  %temp_0_1 = xor i8 %Rcon_load, %sbox_load
  %temp_3_1_34 = select i1 %tmp_9, i8 %temp_3_33, i8 %temp_3_1
  %temp_2_1_35 = select i1 %tmp_9, i8 %temp_2_32, i8 %temp_2_1
  %temp_1_1 = select i1 %tmp_9, i8 %temp_1_31, i8 %temp_3_5
  %temp_0_2 = select i1 %tmp_9, i8 %temp_0_1, i8 %temp_3_8
  %sum = add i8 -16, %tmp_8
  %sum_cast = zext i8 %sum to i32
  %RoundKey_addr_5 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %sum_cast
  %RoundKey_load = load i8* %RoundKey_addr_5, align 1
  %tmp_10 = xor i8 %RoundKey_load, %temp_0_2
  %RoundKey_addr_6 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %tmp_8_cast
  store i8 %tmp_10, i8* %RoundKey_addr_6, align 1
  %sum1 = add i8 -15, %tmp_8
  %sum1_cast = zext i8 %sum1 to i32
  %RoundKey_addr_7 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %sum1_cast
  %RoundKey_load_1 = load i8* %RoundKey_addr_7, align 1
  %tmp_11 = xor i8 %RoundKey_load_1, %temp_1_1
  %tmp_12 = or i8 %tmp_8, 1
  %tmp_22_cast = zext i8 %tmp_12 to i32
  %RoundKey_addr_8 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %tmp_22_cast
  store i8 %tmp_11, i8* %RoundKey_addr_8, align 1
  %sum2 = add i8 -14, %tmp_8
  %sum2_cast = zext i8 %sum2 to i32
  %RoundKey_addr_9 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %sum2_cast
  %RoundKey_load_2 = load i8* %RoundKey_addr_9, align 1
  %tmp_13 = xor i8 %RoundKey_load_2, %temp_2_1_35
  %tmp_14 = or i8 %tmp_8, 2
  %tmp_24_cast = zext i8 %tmp_14 to i32
  %RoundKey_addr_10 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %tmp_24_cast
  store i8 %tmp_13, i8* %RoundKey_addr_10, align 1
  %sum3 = add i8 -13, %tmp_8
  %sum3_cast = zext i8 %sum3 to i32
  %RoundKey_addr_11 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %sum3_cast
  %RoundKey_load_3 = load i8* %RoundKey_addr_11, align 1
  %tmp_15 = xor i8 %RoundKey_load_3, %temp_3_1_34
  %tmp_16 = or i8 %tmp_8, 3
  %tmp_26_cast = zext i8 %tmp_16 to i32
  %RoundKey_addr_12 = getelementptr [240 x i8]* %RoundKey, i32 0, i32 %tmp_26_cast
  store i8 %tmp_15, i8* %RoundKey_addr_12, align 1
  %i_2 = add i6 1, %i_1
  br label %.preheader3
...
define void @Cipher([16 x i32]* %state, [32 x i32]* %Key) nounwind {
  ...
  call fastcc void @KeyExpansion([240 x i8]* %RoundKey, [32 x i32]* %Key) nounwind
  call fastcc void @AddRoundKey(i6 0, [16 x i32]* %state, [240 x i8]* %RoundKey) nounwind
  br label %1
...
; <label>:3                                       ; preds = %4, %2
  ...
  %tmp_19_cast = zext i4 %tmp_s to i32
  %state_addr_13 = getelementptr [16 x i32]* %state, i32 0, i32 %tmp_19_cast
  %tmp_17 = call i32 @_ssdm_op_BitConcatenate.i32.i29.i3(i29 1, i3 %i_i)
  %state_addr_14 = getelementptr [16 x i32]* %state, i32 0, i32 %tmp_17
  %tmp_18 = add i5 %i_i_cast5_cast1, 12
  %tmp_21_cast = zext i5 %tmp_18 to i32
  %state_addr_15 = getelementptr [16 x i32]* %state, i32 0, i32 %tmp_21_cast
  %exitcond_i = icmp eq i3 %i_i, -4
  %empty_36 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4) nounwind
  %i = add i3 %i_i, 1
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_31 = trunc i32 %state_load_25 to i8
  %tmp_32 = trunc i32 %state_load_26 to i8
  %Tm = xor i8 %tmp_31, %t
  %tmp_33 = trunc i32 %state_load_27 to i8
  %tmp = xor i8 %Tm, %tmp_33
  %Tmp = xor i8 %tmp, %tmp_32
  %tmp_34 = shl i8 %Tm, 1
  %tmp_35 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %Tm, i32 7)
  %tmp_9_i_cast_cast = select i1 %tmp_35, i8 27, i8 0
  %tmp1 = xor i8 %tmp_34, %Tmp
  %tmp_i_37 = xor i8 %tmp1, %tmp_9_i_cast_cast
  %tmp_1_i = zext i8 %tmp_i_37 to i32
  %tmp_2_i6 = xor i32 %state_load_24, %tmp_1_i
  store i32 %tmp_2_i6, i32* %state_addr_12, align 4
  %Tm_1 = xor i8 %tmp_32, %tmp_31
  %tmp_36 = shl i8 %Tm_1, 1
  %tmp_37 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %Tm_1, i32 7)
  %tmp_5_i_cast_cast = select i1 %tmp_37, i8 27, i8 0
  %tmp2 = xor i8 %tmp_36, %Tmp
  ...
  %Tm_2 = xor i8 %tmp_33, %tmp_32
  %tmp_38 = shl i8 %Tm_2, 1
  %tmp_39 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %Tm_2, i32 7)
  %tmp_16_i_cast_cast = select i1 %tmp_39, i8 27, i8 0
  %tmp3 = xor i8 %Tmp, %tmp_16_i_cast_cast
  %tmp_18_i = xor i8 %tmp3, %tmp_38
  %tmp_19_i = zext i8 %tmp_18_i to i32
  %tmp_20_i = xor i32 %state_load_26, %tmp_19_i
  store i32 %tmp_20_i, i32* %state_addr_14, align 4
  %Tm_3 = xor i8 %tmp_33, %t
  %tmp_40 = shl i8 %Tm_3, 1
  %tmp_41 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %Tm_3, i32 7)
  %tmp_23_i_cast_cast = select i1 %tmp_41, i8 27, i8 0
  %tmp4 = xor i8 %Tmp, %tmp_23_i_cast_cast
  %tmp_25_i = xor i8 %tmp4, %tmp_40
...
MixColumns.exit:                                  ; preds = %3
  ...
  call fastcc void @AddRoundKey(i6 %round_cast6_cast, [16 x i32]* %state, [240 x i8]* %RoundKey) nounwind
...
; <label>:5                                       ; preds = %1
  ...
  call fastcc void @AddRoundKey(i6 10, [16 x i32]* %state, [240 x i8]* %RoundKey) nounwind
  ret void
}
...
.preheader:                                       ; preds = %1, %.preheader.preheader
  ...
  %tmp_20 = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %j, i2 0)
  %tmp_28_cast = zext i5 %tmp_20 to i6
  %tmp_21 = add i6 %i_cast4_cast, %tmp_28_cast
  %tmp_29_cast = zext i6 %tmp_21 to i32
  %state_addr = getelementptr [16 x i32]* %state, i32 0, i32 %tmp_29_cast
  %exitcond = icmp eq i3 %j, -4
  %empty_38 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4)
  %j_3 = add i3 %j, 1
  br i1 %exitcond, label %.loopexit.loopexit, label %1

; <label>:1                                       ; preds = %.preheader
  %tmp_42 = trunc i6 %round_read to i4
  %tmp1 = call i8 @_ssdm_op_BitConcatenate.i8.i4.i1.i3(i4 %tmp_42, i1 false, i3 %j)
  ...
  %tmp_18 = zext i8 %RoundKey_load to i32
  %state_load = load i32* %state_addr, align 4
  %tmp_19 = xor i32 %state_load, %tmp_18
  store i32 %tmp_19, i32* %state_addr, align 4
  br label %.preheader
