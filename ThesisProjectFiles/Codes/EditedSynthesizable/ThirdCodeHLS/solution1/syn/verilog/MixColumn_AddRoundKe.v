...
reg   [31:0] worda_load_reg_970;
wire   [0:0] tmp_16_fu_429_p2;
reg   [0:0] tmp_16_reg_975;
reg   [31:0] worda_load_1_reg_980;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        worda_address0 = tmp_39_cast_fu_405_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        worda_address0 = tmp_16_cast_fu_342_p1;
    end else begin
        worda_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        worda_address1 = tmp_40_cast_fu_416_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        worda_address1 = tmp_38_cast_fu_357_p1;
    end else begin
        worda_address1 = 'bx;
    end
end
