...
architecture behav of aes_main is 
    ...
    "aes_main,hls_ip_2017_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7eg-ffvf1517-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.257333,HLS_SYN_LAT=1092,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=2136,HLS_SYN_LUT=3470}";
    ...
    signal worda_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal worda_ce0 : STD_LOGIC;
    signal worda_we0 : STD_LOGIC;
    signal worda_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal worda_address1 : STD_LOGIC_VECTOR (8 downto 0);
    signal worda_ce1 : STD_LOGIC;
    signal worda_q1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_MixColumn_AddRoundKe_fu_96_worda_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_MixColumn_AddRoundKe_fu_96_worda_ce0 : STD_LOGIC;
    signal grp_MixColumn_AddRoundKe_fu_96_worda_address1 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_MixColumn_AddRoundKe_fu_96_worda_ce1 : STD_LOGIC;
    ...
    signal grp_KeySchedule_fu_106_worda_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_KeySchedule_fu_106_worda_ce0 : STD_LOGIC;
    signal grp_KeySchedule_fu_106_worda_we0 : STD_LOGIC;
    signal grp_KeySchedule_fu_106_worda_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_KeySchedule_fu_106_worda_address1 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_KeySchedule_fu_106_worda_ce1 : STD_LOGIC;
    ...
    signal grp_AddRoundKey_fu_126_worda_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_AddRoundKey_fu_126_worda_ce0 : STD_LOGIC;
    signal grp_AddRoundKey_fu_126_worda_address1 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_AddRoundKey_fu_126_worda_ce1 : STD_LOGIC;
    ...
    port (
        ...
        worda_address0 : OUT STD_LOGIC_VECTOR (8 downto 0);
        worda_ce0 : OUT STD_LOGIC;
        worda_we0 : OUT STD_LOGIC;
        worda_d0 : OUT STD_LOGIC_VECTOR (31 downto 0);
        worda_q0 : IN STD_LOGIC_VECTOR (31 downto 0);
        worda_address1 : OUT STD_LOGIC_VECTOR (8 downto 0);
        worda_ce1 : OUT STD_LOGIC;
        worda_q1 : IN STD_LOGIC_VECTOR (31 downto 0) );
...
begin
    worda_U : component aes_main_worda
    generic map (
        DataWidth => 32,
        AddressRange => 480,
        AddressWidth => 9)
    ...
    worda_address0_assign_proc : process(grp_MixColumn_AddRoundKe_fu_96_worda_address0, grp_KeySchedule_fu_106_worda_address0, grp_AddRoundKey_fu_126_worda_address0, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state11, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state11))) then 
            worda_address0 <= grp_AddRoundKey_fu_126_worda_address0;
    ...
    worda_address1_assign_proc : process(grp_MixColumn_AddRoundKe_fu_96_worda_address1, grp_KeySchedule_fu_106_worda_address1, grp_AddRoundKey_fu_126_worda_address1, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state11, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state11))) then 
            worda_address1 <= grp_AddRoundKey_fu_126_worda_address1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    worda_ce0_assign_proc : process(grp_MixColumn_AddRoundKe_fu_96_worda_ce0, grp_KeySchedule_fu_106_worda_ce0, grp_AddRoundKey_fu_126_worda_ce0, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state11, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state11))) then 
            worda_ce0 <= grp_AddRoundKey_fu_126_worda_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    worda_ce1_assign_proc : process(grp_MixColumn_AddRoundKe_fu_96_worda_ce1, grp_KeySchedule_fu_106_worda_ce1, grp_AddRoundKey_fu_126_worda_ce1, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state11, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state11))) then 
            worda_ce1 <= grp_AddRoundKey_fu_126_worda_ce1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    worda_we0_assign_proc : process(grp_KeySchedule_fu_106_worda_we0, ap_CS_fsm_state2)
    begin
