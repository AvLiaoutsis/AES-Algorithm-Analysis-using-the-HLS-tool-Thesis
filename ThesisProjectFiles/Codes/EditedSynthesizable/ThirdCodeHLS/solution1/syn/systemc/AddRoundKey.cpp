...
void AddRoundKey::thread_grp_fu_133_p2() {
    grp_fu_133_p2 = (statemt_q0.read() ^ worda_q0.read());
}

void AddRoundKey::thread_grp_fu_139_p2() {
    grp_fu_139_p2 = (statemt_q1.read() ^ worda_q1.read());
}
...
void AddRoundKey::thread_worda_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        worda_address0 =  (sc_lv<9>) (tmp_100_cast_fu_239_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        worda_address0 =  (sc_lv<9>) (tmp_cast_fu_182_p1.read());
    } else {
        worda_address0 =  (sc_lv<9>) ("XXXXXXXXX");
    }
}

void AddRoundKey::thread_worda_address1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        worda_address1 =  (sc_lv<9>) (tmp_101_cast_fu_250_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        worda_address1 =  (sc_lv<9>) (tmp_99_cast_fu_197_p1.read());
    } else {
        worda_address1 =  (sc_lv<9>) ("XXXXXXXXX");
    }
}

void AddRoundKey::thread_worda_ce0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) || 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
...
void AddRoundKey::thread_worda_ce1() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) || 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
