...
aes_main::aes_main(sc_module_name name) : sc_module(name), mVcdFile(0) {
    worda_U = new aes_main_worda("worda_U");
    worda_U->clk(ap_clk);
    worda_U->reset(ap_rst);
    worda_U->address0(worda_address0);
    worda_U->ce0(worda_ce0);
    worda_U->we0(worda_we0);
    worda_U->d0(grp_KeySchedule_fu_106_worda_d0);
    worda_U->q0(worda_q0);
    worda_U->address1(worda_address1);
    worda_U->ce1(worda_ce1);
    worda_U->q1(worda_q1);
    ...
    grp_MixColumn_AddRoundKe_fu_96->worda_address0(grp_MixColumn_AddRoundKe_fu_96_worda_address0);
    grp_MixColumn_AddRoundKe_fu_96->worda_ce0(grp_MixColumn_AddRoundKe_fu_96_worda_ce0);
    grp_MixColumn_AddRoundKe_fu_96->worda_q0(worda_q0);
    grp_MixColumn_AddRoundKe_fu_96->worda_address1(grp_MixColumn_AddRoundKe_fu_96_worda_address1);
    grp_MixColumn_AddRoundKe_fu_96->worda_ce1(grp_MixColumn_AddRoundKe_fu_96_worda_ce1);
    grp_MixColumn_AddRoundKe_fu_96->worda_q1(worda_q1);
    ...
    grp_KeySchedule_fu_106->worda_address0(grp_KeySchedule_fu_106_worda_address0);
    grp_KeySchedule_fu_106->worda_ce0(grp_KeySchedule_fu_106_worda_ce0);
    grp_KeySchedule_fu_106->worda_we0(grp_KeySchedule_fu_106_worda_we0);
    grp_KeySchedule_fu_106->worda_d0(grp_KeySchedule_fu_106_worda_d0);
    grp_KeySchedule_fu_106->worda_q0(worda_q0);
    grp_KeySchedule_fu_106->worda_address1(grp_KeySchedule_fu_106_worda_address1);
    grp_KeySchedule_fu_106->worda_ce1(grp_KeySchedule_fu_106_worda_ce1);
    grp_KeySchedule_fu_106->worda_q1(worda_q1);
    ...
    grp_AddRoundKey_fu_126->worda_address0(grp_AddRoundKey_fu_126_worda_address0);
    grp_AddRoundKey_fu_126->worda_ce0(grp_AddRoundKey_fu_126_worda_ce0);
    grp_AddRoundKey_fu_126->worda_q0(worda_q0);
    grp_AddRoundKey_fu_126->worda_address1(grp_AddRoundKey_fu_126_worda_address1);
    grp_AddRoundKey_fu_126->worda_ce1(grp_AddRoundKey_fu_126_worda_ce1);
    grp_AddRoundKey_fu_126->worda_q1(worda_q1);
    ...
    SC_METHOD(thread_worda_address0);
    sensitive << ( grp_MixColumn_AddRoundKe_fu_96_worda_address0 );
    sensitive << ( grp_KeySchedule_fu_106_worda_address0 );
    sensitive << ( grp_AddRoundKey_fu_126_worda_address0 );
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( ap_CS_fsm_state8 );
    sensitive << ( ap_CS_fsm_state11 );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_worda_address1);
    sensitive << ( grp_MixColumn_AddRoundKe_fu_96_worda_address1 );
    sensitive << ( grp_KeySchedule_fu_106_worda_address1 );
    sensitive << ( grp_AddRoundKey_fu_126_worda_address1 );
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( ap_CS_fsm_state8 );
    sensitive << ( ap_CS_fsm_state11 );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_worda_ce0);
    sensitive << ( grp_MixColumn_AddRoundKe_fu_96_worda_ce0 );
    sensitive << ( grp_KeySchedule_fu_106_worda_ce0 );
    sensitive << ( grp_AddRoundKey_fu_126_worda_ce0 );
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( ap_CS_fsm_state8 );
    sensitive << ( ap_CS_fsm_state11 );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_worda_ce1);
    sensitive << ( grp_MixColumn_AddRoundKe_fu_96_worda_ce1 );
    sensitive << ( grp_KeySchedule_fu_106_worda_ce1 );
    sensitive << ( grp_AddRoundKey_fu_126_worda_ce1 );
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( ap_CS_fsm_state8 );
    sensitive << ( ap_CS_fsm_state11 );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_worda_we0);
    sensitive << ( grp_KeySchedule_fu_106_worda_we0 );
    sensitive << ( ap_CS_fsm_state2 );
    ...
    sc_trace(mVcdFile, worda_address0, "worda_address0");
    sc_trace(mVcdFile, worda_ce0, "worda_ce0");
    sc_trace(mVcdFile, worda_we0, "worda_we0");
    sc_trace(mVcdFile, worda_q0, "worda_q0");
    sc_trace(mVcdFile, worda_address1, "worda_address1");
    sc_trace(mVcdFile, worda_ce1, "worda_ce1");
    sc_trace(mVcdFile, worda_q1, "worda_q1");
    ...
    sc_trace(mVcdFile, grp_MixColumn_AddRoundKe_fu_96_worda_address0, "grp_MixColumn_AddRoundKe_fu_96_worda_address0");
    sc_trace(mVcdFile, grp_MixColumn_AddRoundKe_fu_96_worda_ce0, "grp_MixColumn_AddRoundKe_fu_96_worda_ce0");
    sc_trace(mVcdFile, grp_MixColumn_AddRoundKe_fu_96_worda_address1, "grp_MixColumn_AddRoundKe_fu_96_worda_address1");
    sc_trace(mVcdFile, grp_MixColumn_AddRoundKe_fu_96_worda_ce1, "grp_MixColumn_AddRoundKe_fu_96_worda_ce1");
    ...
    sc_trace(mVcdFile, grp_KeySchedule_fu_106_worda_address0, "grp_KeySchedule_fu_106_worda_address0");
    sc_trace(mVcdFile, grp_KeySchedule_fu_106_worda_ce0, "grp_KeySchedule_fu_106_worda_ce0");
    sc_trace(mVcdFile, grp_KeySchedule_fu_106_worda_we0, "grp_KeySchedule_fu_106_worda_we0");
    sc_trace(mVcdFile, grp_KeySchedule_fu_106_worda_d0, "grp_KeySchedule_fu_106_worda_d0");
    sc_trace(mVcdFile, grp_KeySchedule_fu_106_worda_address1, "grp_KeySchedule_fu_106_worda_address1");
    sc_trace(mVcdFile, grp_KeySchedule_fu_106_worda_ce1, "grp_KeySchedule_fu_106_worda_ce1");
    ...
    sc_trace(mVcdFile, grp_AddRoundKey_fu_126_worda_address0, "grp_AddRoundKey_fu_126_worda_address0");
    sc_trace(mVcdFile, grp_AddRoundKey_fu_126_worda_ce0, "grp_AddRoundKey_fu_126_worda_ce0");
    sc_trace(mVcdFile, grp_AddRoundKey_fu_126_worda_address1, "grp_AddRoundKey_fu_126_worda_address1");
    sc_trace(mVcdFile, grp_AddRoundKey_fu_126_worda_ce1, "grp_AddRoundKey_fu_126_worda_ce1");
...
void aes_main::thread_worda_address0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) || 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state11.read()))) {
        worda_address0 = grp_AddRoundKey_fu_126_worda_address0.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        worda_address0 = grp_KeySchedule_fu_106_worda_address0.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        worda_address0 = grp_MixColumn_AddRoundKe_fu_96_worda_address0.read();
    } else {
        worda_address0 =  (sc_lv<9>) ("XXXXXXXXX");
    }
}

void aes_main::thread_worda_address1() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) || 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state11.read()))) {
        worda_address1 = grp_AddRoundKey_fu_126_worda_address1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        worda_address1 = grp_KeySchedule_fu_106_worda_address1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        worda_address1 = grp_MixColumn_AddRoundKe_fu_96_worda_address1.read();
    } else {
        worda_address1 =  (sc_lv<9>) ("XXXXXXXXX");
    }
}

void aes_main::thread_worda_ce0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) || 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state11.read()))) {
        worda_ce0 = grp_AddRoundKey_fu_126_worda_ce0.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        worda_ce0 = grp_KeySchedule_fu_106_worda_ce0.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        worda_ce0 = grp_MixColumn_AddRoundKe_fu_96_worda_ce0.read();
    } else {
        worda_ce0 = ap_const_logic_0;
    }
}

void aes_main::thread_worda_ce1() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) || 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state11.read()))) {
        worda_ce1 = grp_AddRoundKey_fu_126_worda_ce1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        worda_ce1 = grp_KeySchedule_fu_106_worda_ce1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        worda_ce1 = grp_MixColumn_AddRoundKe_fu_96_worda_ce1.read();
    } else {
        worda_ce1 = ap_const_logic_0;
    }
}

void aes_main::thread_worda_we0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        worda_we0 = grp_KeySchedule_fu_106_worda_we0.read();
    } else {
        worda_we0 = ap_const_logic_0;
    }
}
