set moduleName MixColumn_AddRoundKe
...
set C_modelName {MixColumn_AddRoundKe}
set C_modelType { void 0 }
set C_modelArgList {
	{ statemt int 32 regular {array 32 { 2 2 } 1 1 }  }
	{ n int 4 regular  }
	{ worda int 32 regular {array 480 { 1 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "statemt", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "n", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "worda", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "worda","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 119,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ worda_address0 sc_out sc_lv 9 signal 2 } 
	{ worda_ce0 sc_out sc_logic 1 signal 2 } 
	{ worda_q0 sc_in sc_lv 32 signal 2 } 
	{ worda_address1 sc_out sc_lv 9 signal 2 } 
	{ worda_ce1 sc_out sc_logic 1 signal 2 } 
	{ worda_q1 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	worda { ap_memory {  { worda_address0 mem_address 1 9 }  { worda_ce0 mem_ce 1 1 }  { worda_q0 mem_dout 0 32 }  { worda_address1 mem_address 1 9 }  { worda_ce1 mem_ce 1 1 }  { worda_q1 mem_dout 0 32 } } }
}
