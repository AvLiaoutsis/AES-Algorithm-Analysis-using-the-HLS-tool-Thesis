...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        word_address0 = tmp_100_cast_fu_239_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        word_address0 = tmp_cast_fu_182_p1;
    end else begin
        word_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        word_address1 = tmp_101_cast_fu_250_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        word_address1 = tmp_99_cast_fu_197_p1;
    end else begin
        word_address1 = 'bx;
    end
end
...
assign grp_fu_133_p2 = (statemt_q0 ^ word_q0);

assign grp_fu_139_p2 = (statemt_q1 ^ word_q1);
