...
`define AUTOTB_DUT      aes_main
`define AUTOTB_DUT_INST AESL_inst_aes_main
`define AUTOTB_TOP      apatb_aes_main_top
`define AUTOTB_LAT_RESULT_FILE "aes_main.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "aes_main.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_aes_main_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_MEM_statemt AESL_automem_statemt
`define AESL_MEM_INST_statemt mem_inst_statemt
...
`define AUTOTB_TVIN_statemt_out_wrapc  "../tv/rtldatafile/rtl.aes_main.autotvin_statemt.dat"
`define AUTOTB_TVIN_key_out_wrapc  "../tv/rtldatafile/rtl.aes_main.autotvin_key.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.aes_main.autotvin_out_r.dat"
...
`define AUTOTB_TVOUT_statemt_out_wrapc  "../tv/rtldatafile/rtl.aes_main.autotvout_statemt.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.aes_main.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1092;
parameter LENGTH_statemt = 32;
parameter LENGTH_key = 32;
parameter LENGTH_out_r = 32;
...
//------------------------arraystatemt Instantiation--------------

// The input and output of arraystatemt
wire    arraystatemt_ce0, arraystatemt_ce1;
wire    arraystatemt_we0, arraystatemt_we1;
wire    [4 : 0]    arraystatemt_address0, arraystatemt_address1;
wire    [31 : 0]    arraystatemt_din0, arraystatemt_din1;
wire    [31 : 0]    arraystatemt_dout0, arraystatemt_dout1;
wire    arraystatemt_ready;
wire    arraystatemt_done;

`AESL_MEM_statemt `AESL_MEM_INST_statemt(
    .clk        (AESL_clock),
    .rst        (AESL_reset),
...
assign arraystatemt_address0 = statemt_address0;
assign arraystatemt_ce0 = statemt_ce0;
assign statemt_q0 = arraystatemt_dout0;
assign arraystatemt_we0 = statemt_we0;
assign arraystatemt_din0 = statemt_d0;
assign arraystatemt_address1 = statemt_address1;
assign arraystatemt_ce1 = statemt_ce1;
assign statemt_q1 = arraystatemt_dout1;
assign arraystatemt_we1 = statemt_we1;
assign arraystatemt_din1 = statemt_d1;
assign arraystatemt_ready= ready;
assign arraystatemt_done = interface_done;
...
wire    [4 : 0]    arrayout_r_address0, arrayout_r_address1;
...
reg end_statemt;
reg [31:0] size_statemt;
reg [31:0] size_statemt_backup;
reg end_key;
reg [31:0] size_key;
...
reg dump_tvout_finish_statemt;

initial begin : dump_tvout_runtime_sign_statemt
    integer fp;
    dump_tvout_finish_statemt = 0;
    fp = $fopen(`AUTOTB_TVOUT_statemt_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_statemt_out_wrapc);
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_statemt_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_statemt_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
