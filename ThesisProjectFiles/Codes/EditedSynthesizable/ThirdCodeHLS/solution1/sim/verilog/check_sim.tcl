...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.aes_main.autotvin_statemt.dat"
         "c.aes_main.autotvin_key.dat"
         "c.aes_main.autotvin_out_r.dat"
         "c.aes_main.autotvout_statemt.dat"
         "c.aes_main.autotvout_out_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.aes_main.autotvout_statemt.dat"
         "rtl.aes_main.autotvout_out_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
