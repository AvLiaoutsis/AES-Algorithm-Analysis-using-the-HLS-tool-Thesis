...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "aes_main.autotvin.dat"
	set constFileTvOut       "aes_main.autotvout.dat"
	set constFileHdlTvIn     "aes_main.autohdltvin.dat"
	set constFileHdlTvOut    "aes_main.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
