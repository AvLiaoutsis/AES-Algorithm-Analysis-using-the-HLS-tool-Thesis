...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("state_address0", 2, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("state_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("state_we0", 1, hls_out, 0, "ap_memory", "mem_we", 1),
	Port_Property("state_d0", 128, hls_out, 0, "ap_memory", "mem_din", 1),
	Port_Property("state_q0", 128, hls_in, 0, "ap_memory", "mem_dout", 1),
	Port_Property("state_address1", 2, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("state_ce1", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("state_we1", 1, hls_out, 0, "ap_memory", "mem_we", 1),
	Port_Property("state_d1", 128, hls_out, 0, "ap_memory", "mem_din", 1),
	Port_Property("state_q1", 128, hls_in, 0, "ap_memory", "mem_dout", 1),
