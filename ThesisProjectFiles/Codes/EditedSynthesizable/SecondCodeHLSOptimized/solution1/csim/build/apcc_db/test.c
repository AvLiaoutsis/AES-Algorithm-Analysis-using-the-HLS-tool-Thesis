...
void Cipher(signed int (*)[4], signed int *);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @Cipher([4 x i32]* %%18, i32* %%19) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_235_count);
  Cipher(llvm_cbe_tmp__19, (signed int *)llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
